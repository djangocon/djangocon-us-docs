...
A little about DjangoCon US: We are a nonprofit conference with about 400 attendees. We're looking for diverse topics that represent the experiences of our community, not just talks on the Django web framework. We have a Code of Conduct with a response plan and Opportunity Grants are available if cost is a concern. Our CFP closes on [date]: [link to CFP].  
